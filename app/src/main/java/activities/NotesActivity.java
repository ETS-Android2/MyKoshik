...
public class NotesActivity extends AppCompatActivity {
                ...
                mIVSaveNote.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if ((HeadLine.toString().length() != 0) && (Text.toString().length() != 0)) {
                            ...
                            Toast.makeText(NotesActivity.this, "Успішно додано нотатку", Toast.LENGTH_LONG).show();
                        }
                        else
                           Toast.makeText(NotesActivity.this, "Не всі поля заповнені!", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void addNoteToLL(final StringBuffer mSBHeadLine, final long id) {
        ...
        final TextView mTVHeadLine = new TextView(NotesActivity.this);
        ...
        ImageView mIVDeleteNote = new ImageView(NotesActivity.this);
        mIVDeleteNote.setLayoutParams(layoutParams1);
        mIVDeleteNote.setBackground(getDrawable(R.drawable.rubbish_bin_sign_notesactivity));

        ImageView mIVRefactorNote = new ImageView(NotesActivity.this);
        mIVRefactorNote.setBackground(getDrawable(R.drawable.refactor_sign_notesactivity));
        mIVRefactorNote.setLayoutParams(layoutParams1);

        LinearLayout.LayoutParams layoutParams2 = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        layoutParams2.setMargins(15,0,15,100);

        final LinearLayout mLLCopy = new LinearLayout(NotesActivity.this);
                ...
                mIVSaveNote.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if ((headLine.toString().length() != 0) && (text.toString().length() != 0)) {
                            ...
                            Toast.makeText(NotesActivity.this, "Успішно збережено зміни", Toast.LENGTH_LONG).show();
                        }
                        else
                            Toast.makeText(NotesActivity.this, "Не всі поля заповнені!", Toast.LENGTH_SHORT).show();
